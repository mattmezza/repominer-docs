\chapter{Organizzazione del progetto}	
		...
		\centering
			\begin{tabular}{|C{4cm}|C{4cm}|C{4cm}|}
				...
				\hline
				Matteo Merola & Team member & Sviluppo deliverables: DL1, DL2, DL3, DL6,DL8, DL9\tabularnewline
				\hline
				Simone Scalabrino & Team member & Sviluppo deliverables: DL1, DL2, DL4, DL5, DL7, DL10, DL11\tabularnewline
				\hline
				Giovanni Grano & Team member & Sviluppo deliverables: DL1, DL2, DL3, DL6, DL8, DL9\tabularnewline
				\hline
				Carlo Branca & Team member & Sviluppo deliverables: DL1, DL2, DL4, DL5, DL7, DL10, DL11\tabularnewline
				\hline
			\end{tabular}
