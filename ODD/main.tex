...
%%%%%%%% javadoc doclet http://doclet.github.io   %%%%%%%%%%%%%%%%%%%%%%
...
\titlelabel{\thetitle.\quad}   % For consistency in all headin
...
{\large 13 Luglio 2014} % Date, change the \today to a set date if you want to be precise
...
\end{titlepage}	
	...
	\input{Design}
\chapter{Interfaccia delle classi} {
