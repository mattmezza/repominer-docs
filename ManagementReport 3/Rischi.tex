...
In questa sezione si analizza l'evoluzione dei rischi e come sono cambiate le probabilità che un determinato rischio si verifichi. 
\\ \\
\textbf{Legenda} \\ \\
\textit{Probabilità}:
\begin{itemize}
...
\hline
Implementazione non completa 						& Invariata: Nulla & Serio \tabularnewline
\hline
Attività prolungata oltre la scadenza prevista in fase di schedule 	& Invariata: Bassa   & Serio \tabularnewline
\hline
...
I rischi identificati in fase di pianificazione sono sostanzialmente rimasti invariati.
