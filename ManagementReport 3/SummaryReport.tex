...
\begin{tabular}{|g|p{8cm}|}
 \hline
  ...
  \hline
  Stato passato del progetto		& \cellcolor{green}\\
  \hline
\end{tabular}
\end{table}
...
\begin{tabular}{|h|p{2cm}|p{2cm}|p{5.5cm}|}
  ...
  \hline
  Sistema		& \cellcolor{green}	& \cellcolor{green}	& \footnotesize Il terzo incremento è stato terminato in tempo\\
  \hline
  Schedule		& \cellcolor{green}	& \cellcolor{green}	& \footnotesize Il nuovo schedule è rispettato\\
  \hline
